  ...
  return (
    <div className="main-content">
      ...
      <p>
        ...
        <p>
          Feel free to make get requests to this database with the links below.
          <p>
            The content of the data is written in JSX, so unless you're working
            with a React application, it's going to be a bit difficult to use
      ...
      <h5 style={{ marginTop: '2rem' }}>Adding Data to the Website/Database</h5>
      <p>
