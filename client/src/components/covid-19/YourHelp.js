    ...
    <div className="main-content">
      ...
      <Collapsible
        ...
        content={
          <>
            <p>
              Open to all: licensed health care professionals, students, or even
              volunteers interested in Emergency Response.
            </p>
            <p>
              Volunteer{' '}
      ...
      <Collapsible
        ...
        content={
          <>
            <p>
              Learn more{' '}
              <a href="https://www.girlscouts.org/en/cookie-care.html">here</a>.
            </p>
      ...
      <Collapsible
        ...
        content={
          <>
            <p>
              Money from PekoPeko's Feed it Forward program goes towards feeding
              Baltimore’s healthcare workers and meal programs for vulnerable
              Baltimoreans.{' '}
            </p>
            <p>
      ...
      <Collapsible
        ...
        content={
          <>
            ...
            <p>
              Volunteer or donate to Invisible Hands in the <b>NY & NJ Area</b>{' '}
              <a href="https://www.invisiblehandsdeliver.com/volunteer">here</a>
              .
            </p>
          </>
        }
        ...
        content={
          <>
            <p>
              ...
              undergraduate mentors with K-12 students who have been affected by
              school closures. The goal of this virtual service is to provide a
              resource for students including tutoring, college preparation, and
              mentorship.
            </p>
            <p>
      ...
      <Collapsible
        ...
        content={
          <>
            <p>
              Network of JHU affiliates and Baltimore locals helping each other
        ...
        content={
          <>
            <p>
              ...
              back into the closet due to mandatory quarantines in many states.
            </p>
            <p>
              Donate <a href="https://www.bagly.org/covid19-direct-aid">here</a>
              .
            </p>
          </>
        }
